            ...
            {selectedWorkout ? (
                ...
                <div>
                    {Object.keys(workouts).length > 0 ? (
                        <ul className='list-group workout-group'>
                    ...
                    <button className="btn btn-lg btn-primary position-fixed bottom-0 end-0 m-4" onClick={navigateToCreateWorkout}>Create Training Program</button>
                </div>
            )}
        </div>
    );
